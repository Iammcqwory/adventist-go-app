...
```bash
git remote add encore encore://adventist-go-app-tszi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/adventist-go-app-tszi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/adventist-go-app-tszi/settings/integrations/github)
